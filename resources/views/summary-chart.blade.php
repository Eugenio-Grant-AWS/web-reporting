...
<style>
    #jsmind_container, #jsmind_container_2 {
        width: 100%;
        height: 100%;
        ...
        "data": {
            ...
            "children": [
                ...
                },
                {
                    ...
                    "direction": "right",
                    "children": [
                        { "id": "dataprocessing", "topic": "Data processing systems" },
                        { "id": "streaming", "topic": "Streaming applications" },
                        { "id": "continuous", "topic": "Continuous integration/continuous delivery" }
                    ]
                },
                {
                    "id": "benefits",
                    ...
                    "direction": "right",
                    "children": [
                        { "id": "performance", "topic": "Enhanced performance via parallelism" },
                        { "id": "optimization", "topic": "Segmentation allows for optimization" }
                    ]
                },
                {
                    "id": "tradeoffs",
                    ...
                    "direction": "right",
                    "children": [
                        { "id": "complexity", "topic": "Complexity in coordinating stages" },
                        { "id": "bottlenecks", "topic": "Potential for bottlenecks if stages aren't balanced" }
                    ]
                },
                {
                    "id": "antipatterns",
                    ...
                    "direction": "right",
                    "children": [
                        { "id": "sync_issues", "topic": "Inefficient synchronization mechanisms" },
                        { "id": "oversegmentation", "topic": "Over-segmentation leading to overhead" }
                    ]
                },
                {
                    "id": "challenges",
                    ...
                    "direction": "right",
                    "children": [
                        { "id": "sync", "topic": "Maintaining synchronization" },
                        { "id": "workload", "topic": "Balancing the workload across stages" }
                    ]
                }
            ]
        }
