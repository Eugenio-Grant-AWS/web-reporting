...
class ReachExposureController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $uniqueSegur = $mediaTypes->pluck('QuoSegur')->unique();
        ...
        if ($request->has('uniqueSegur') && !empty($request->uniqueSegur)) {
            $mediaTypes = $mediaTypes->whereIn('QuoSegur', $request->uniqueSegur);
        }
        ...
        return view('reach-exposure', compact('breadcrumb', 'chartData', 'dataMessage', 'uniqueGender', 'uniqueAge', 'uniqueSegur', 'uniqueAdjusted_value', 'uniqueMediaType'));
    }
